...
export default function CompanyDetailPage() {
  ...
  const { companies, loading, updateCompanySettings, deleteCompany } = useCompanies();
    ...
    return (
      <div className="page">
        ...
        <main className="page__content">
          <p className="loading-state">Loading company…</p>
        </main>
      </div>
    );
  }
  ...
  const companyGuideLevel =
    levelOrMin(company.readinessLevels?.[CURRENT_YEAR]?.[guideMetric]);
